...
def train(model, trainDataloader, valDataloader, epoch, loss, optimizer, best_path, normal_path):
    best = 1000000000
...
def train_long(model, trainDataloader, valDataloader, epoch, loss, optimizer, best_path, normal_path):
    best = 1000000000
    device = torch.device("cuda:0" if torch.cuda.is_available() else "cpu")
    ave_train_loss = []
    ave_val_loss = []
...
if __name__ == "__main__":
    train_trafficPath = r"C:\\Users\bigti\\research\\StreetFunction\\Data\\train\\data"
    val_trafficPath = r"C:\\Users\bigti\\research\\StreetFunction\\Data\\val\\data"
    test_trafficPath = r"C:\\Users\bigti\\research\\StreetFunction\\Data\\test\\data"

    train_adjPath = r"C:\\Users\\bigti\\research\\StreetFunction\\Data\\train\\adj"
    val_adjPath = r"C:\\Users\\bigti\\research\\StreetFunction\\Data\\val\\adj"
    ...
    inLength = 24
    train_dataset = NYCTrafficCountDataset_long(trainTrafficLst, xLst, trainAdjLst, trainDateLst, scenePath, inLength)
    # test_dataset = NYCTrafficCountDataset_short(testTrafficLst, xLst, testAdjLst, testDateLst, scenePath, inLength)
    val_dataset = NYCTrafficCountDataset_long(valTrafficLst, xLst, valAdjLst, valDateLst, scenePath, inLength)
    ...
    best_path = r"C:\\Users\bigti\\research\\StreetFunction\\weights_new_all_long_24\\best\\best.pt"
    normal_path = r"C:\\Users\bigti\\research\\StreetFunction\\weights_new_all_long_24\\normal"
    

    train_loss, val_loss = train_long(net, 
                                 training_dataloader,
